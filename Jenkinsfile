pipeline {
  ...
  stages {
	...
	stage('Checkstyle Report') {
      steps {
        sh 'vendor/bin/phpcs --report=checkstyle --report-file=build/logs/checkstyle.xml --standard=phpcs.xml.dist --extensions=php,inc --ignore=autoload.php vendor/dynamic/silverstripe-base-site/src/ vendor/dynamic/silverstripe-base-site/tests/'
	  }
    }
